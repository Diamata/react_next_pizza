...
const Index = ({orders, products}) => {
    ...
    const handleDelete = async (id) => {
        try {
            const res = await axios.delete('http://176.99.11.170:88/api/products/' + id);
    ...
    const handleStatus = async (id) => {
        ...
        try {
            const res = await axios.put('http://176.99.11.170:88/api/orders/' + id, {
...
export async function getServerSideProps (ctx)  {
    ...
    const productRes = await axios.get('http://176.99.11.170:88/api/products');
    const orderRes = await axios.get('http://176.99.11.170:88/api/orders');
